...
final class ProEntitlementService {
  ProEntitlementService({required this._repository, required this._cache}) {
  ...
  bool get hasLifetimePro =>
      isPro && activeProductIdNotifier.value == ProProductIds.lifetime;
  ...
  Future<bool> purchaseProduct(String? productId) async {
    return _startPurchase(() => _repository.purchasePro(productId: productId));
  }
  ...
  _ResolvedStatusWait _startWaitForResolvedStatus({required Duration timeout}) {
