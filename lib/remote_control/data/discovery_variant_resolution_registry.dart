...
///
/// Separate from VariantResolutionRegistry.resolve, which resolves a
/// behavioral variant (which dialect within an already-fixed transport) from
/// a live adapter probe. Never both live at once: discovery source is only
/// known before first contact, TvDeviceInfo only after.
