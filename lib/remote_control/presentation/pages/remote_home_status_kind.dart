...
extension RemoteHomeStatusKindL10n on RemoteHomeStatusKind {
  String localize(AppLocalizations l10n) => switch (this) {
        RemoteHomeStatusKind.connectTvToBegin =>
          l10n.remoteStatusConnectTvToBegin,
        RemoteHomeStatusKind.ready => l10n.remoteStatusReady,
        RemoteHomeStatusKind.transportIdle => l10n.remoteStatusTransportIdle,
        RemoteHomeStatusKind.noDeviceSelected =>
          l10n.remoteStatusNoDeviceSelected,
        ...
        RemoteHomeStatusKind.keyboardUnavailable =>
          l10n.remoteKeyboardUnavailable,
      };
}
