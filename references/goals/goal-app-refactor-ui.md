...
| 5.2 | Implement capability detection per 5.1 design; update `TvDevice.fromJson` / pairing flow to persist and restore per-device capabilities correctly | D6 | `abstraction-domain-modeling`, `framework-mastery` | 5.1 | MEDIUM | pending |
