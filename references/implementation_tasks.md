...
- [x] Milestone 3 / Task 3.1 (partial):
  ...
  - [x] Settings sheet: platform store-account hints, privacy-policy link, UMP privacy-options when required, diagnostics summary + copy report (**TVREMOTE-29** / **TVREMOTE-66**)
