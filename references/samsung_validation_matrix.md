...
and `cancelPairing` recovery.
- *2026-05-22* — **Physical runs recorded:** outcome table — A/B/C all `pass`
on Samsung TV (2026-05-22). No TV-specific gaps filed; known-good matrix row
still optional for model/firmware detail.
